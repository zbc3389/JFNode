...
## 暗铸系统
- 必须拥有至少一个节点！
- 可申请成为铸造人，消耗钻石，和以往的消费制度一样，包月包季度包年或永久。
- 必须是铸造人才可以铸造自定义名字的积分，比如：“哈哈积分”，“汽车荣耀积分”。
- 初始数量最小1个，最大1000亿个。
- 初始价格按铸造时使用的波场价值来定，比如你铸造1000个，花费价值1000个波场来铸造，每个就是1元的价值，如果用1元价值的波场铸造1000个，每个就是0.0001元的价值。
- 通过注入波场的方式可以提升每个积分的价格。
