...
## 投票决议系统
- 通过投票来决飓风节点今后的走向，你们的每一票都很重要。
- 任何可注册登录的用户都可以参与投票。
- 每人可以投无数次，只要你有钱。
- 每次投票消耗的单位按投票消耗类型和投票消耗单价扣除后计票。
- 时间到时检测票数，同意票数大于等于合格票数算通过投票，反对票数大于等于合格票数算否决投票，当投票数大于等于合格票数3倍（暂定）时，立即触发无需等待时间到达。
- 投票信息到期或触发后不被删除，查看投票状态即可知道当前状态时什么，“投票中”、“已触发”、“未通过”。
- 该功能研发中...
